...
public class KMap {
    ...
    public static enum KNumeric {
        ...
        INT_DRIVETRAIN_RIGHT_SLAVE_0_ID(13, 13), // TODO: Check practice vals on these motors
        ...
        // Pivot Arm
        DBL_PIVOT_ARM_KP(8, 8),
        DBL_PIVOT_ARM_KI(0.01, 0.005),
        DBL_PIVOT_ARM_KD(300, 300),
        INT_PIVOT_ARM_KIZONE(40, 40),
        ...
        INT_ELEVATOR_RANGE_WITHIN_TARGET(5, 5),
        // Teleop Drive
        ...
        INT_PIVOT_ARM_RANGE_WITHIN_TARGET(5, 5),
        // End Effector
