...
public class KMap {
    ...
    public static enum KNumeric {
        ...
        DBL_GRABBER_LENGTH_INCHES(10, 10), //16?
        ...
        INT_PIVOT_ARM_ENCODER_OFFSET(1022, 1232),
        ...
        INT_END_EFFECTOR_WRIST_MIN_POSITION(1095, 1095), // 1030 // 850
        INT_END_EFFECTOR_WRIST_MAX_POSITION(2993, 2993), // 3125 // 3164// 1092
        DBL_WRIST_JOG_CONTROL_MULTIPLIER(15, 15),
        INT_END_EFFECTOR_ENCODER_OFFSET(-1048, -1048), // 3096 // old is 2846
        // RobotVars
