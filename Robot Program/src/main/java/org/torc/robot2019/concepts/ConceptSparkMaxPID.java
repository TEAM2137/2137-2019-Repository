...
public class ConceptSparkMaxPID extends OpMode {
    ...
    public void INIT() {
        ...
        // initialize motor
        m_motor_left = new CANSparkMax((int) SmartDashboard.getNumber("CAN ID Left Master", leftMasterID), MotorType.kBrushless);
        m_motor_left_slave1 = new CANSparkMax((int) SmartDashboard.getNumber("CAN ID Left Slave 1", leftSlave1ID), MotorType.kBrushless);
        m_motor_left_slave2 = new CANSparkMax((int) SmartDashboard.getNumber("CAN ID Left Slave 2", leftSlave2ID), MotorType.kBrushless);

        m_motor_right = new CANSparkMax((int) SmartDashboard.getNumber("CAN ID Right Master", rightMasterID), MotorType.kBrushless);
        m_motor_right_slave1 = new CANSparkMax((int) SmartDashboard.getNumber("CAN ID Right Slave 1", rightSlave1ID), MotorType.kBrushless);
        m_motor_right_slave2 = new CANSparkMax((int) SmartDashboard.getNumber("CAN ID Right Slave 2", rightSlave2ID), MotorType.kBrushless);
